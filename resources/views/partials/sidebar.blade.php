    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/keuangan/tagihan" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Tagihan
              </p>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
            <li class="nav-item">
            <a href="/tagihan/dashboard" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Dashboard
              </p>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/tagihan/disetujui" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p> <small>Request Material Management</small></p>
                </a>
              </li>
            </ul>
          </li>
      ...
      @elseif(session()->get('id_user_level') == '6')
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/manager/tagihan/terverifikasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tagihan Terverifikasi</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="/manager/log_project" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Log
              </p>
